...
/* in file queueInsert.c */
extern	status	queueInsert(pid32, qid16, int32);

/* in file queueInsertd.c */
extern	status	queueInsertd(pid32, qid16, int32);
...
/* in file reschedule.c */
extern	void	reschedule(void);
extern	status	reschedule_cntl(int32);
